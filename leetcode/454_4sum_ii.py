...
===============================
The idea is to aggregate pairs in two lists at a time and then aggregate the 2 aggregated lists.
This is just beautiful: https://discuss.leetcode.com/topic/67659/easy-2-lines-o-n-2-python
"""
