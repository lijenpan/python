...
===============================
Super detailed explanation: https://discuss.leetcode.com/topic/39834/step-by-step-tackling-of-the-problem/2
"""
...
def rob(root):
    ...
    def rob_next(root):
        if root is None:
            return [0, 0]
        left = rob_next(root.left)
        right = rob_next(root.right)
        res = [0, 0]
