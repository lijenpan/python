...
If there are 5 stones in the heap, could you figure out a way to remove the stones such that you will always
be the winner?
==============================
The question tells you the condition you will not win.
"""
